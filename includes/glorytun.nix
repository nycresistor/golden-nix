  ...
  interfaceOpts = { ... }: {
    ...
    options = {
      ...
      bindAddress = mkOption {
        default = "0.0.0.0";
        type = with types; str;
        description = ''The address glorytun will bind to. Currently glorytun can only work
      ...
      remoteAddress = mkOption {
        ...
        default = null;
        description = ''The address of the remote glorytun endpoint. Client side option only.
...
in
{
  options.networking.glorytun = {
    ...
    interfaces = mkOption {
      description = ''Glorytun interfaces. NOTE: This module does not configure the IP, Routes, or Firewall of the interface.
      '';
      default = { };
      example = {
        gtc-main = {
